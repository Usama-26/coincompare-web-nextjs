...
export const CoinMarketProvider = ({ children }) => {
  ...
  // const [openCompareCryptoModal, setopenCompareCryptoModal] = useState(false);
  ...
  //   setopenCompareCryptoModal(true);
  // };

  // const addCompareListItem = (item) => {
  //   console.log(item);
  ...
  //       method: "POST",
  //       body: JSON.stringify({ amount, creditDate, creditNumber, selectedToBuy }),
  //       // body:{ email:"ana@gmail.com",password:"ana@123" } ,
  ...
  return (
    <CoinMarketContext.Provider
      value={{
        ...
        // openModal,
        // openCompareModal,
        // openCompareCryptoModal,
        // setopenCompareCryptoModal,
        // addCompareListItem,
        // compareList,
        // setCompareList,
        // authLogin,
