export default function Footer() {
  return (
    <footer class="bg-white dark:bg-blue-gray-900/50 mt-20">
      ...
      {/* <div class="py-6 px-4 bg-blue-gray-100 dark:bg-blue-gray-700 md:flex md:items-center md:justify-between">
